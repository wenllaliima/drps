const INSTRUMENTS = {
  ...
  copsoq2s: {
    ...
    nQuestions: 41,
    scoring: 'copsoq', // mean * 25
    factors: [
      {name:"Exigências Quantitativas",qs:[0,1,2]},
      {name:"Ritmo de Trabalho",qs:[3]},
      {name:"Exigências Cognitivas",qs:[4,5,6]},
      {name:"Exigências Emocionais",qs:[7,8,9]},
      {name:"Influência no Trabalho",qs:[10,11,12]},
      {name:"Possibilidades de Desenvolvimento",qs:[13,14,15]},
      {name:"Previsibilidade",qs:[16,17]},
      {name:"Reconhecimento e Recompensas",qs:[18,19]},
      {name:"Transparência do Papel",qs:[20,21,22]},
      {name:"Qualidade da Liderança",qs:[23,24,25,26]},
      {name:"Apoio Social de Colegas",qs:[27,28,29]},
      {name:"Confiança na Liderança",qs:[30,31,32]},
      {name:"Justiça e Respeito",qs:[33,34,35,36]},
      {name:"Conflito Trabalho-Família",qs:[37,38,39]},
      {name:"Saúde Geral",qs:[40]},
    ],
    dimensions: [
      {name:"EXIGÊNCIAS NO TRABALHO",abbr:"EXT",factors:[0,1,2,3],color:"#ef4444",desc:"Sobrecarga quantitativa, cognitiva, emocional e ritmo."},
      {name:"ORGANIZAÇÃO E CONTEÚDO",abbr:"ORC",factors:[4,5,6],color:"#f59e0b",desc:"Influência, desenvolvimento e previsibilidade."},
      {name:"RELAÇÕES E LIDERANÇA",abbr:"REL",factors:[7,8,9,10,11],color:"#3b82f6",desc:"Reconhecimento, papel, liderança, apoio e confiança."},
      {name:"INTERFACE TRABALHO-FAMÍLIA",abbr:"ITF",factors:[13],color:"#8b5cf6",desc:"Conflito entre demandas do trabalho e da vida privada."},
      {name:"VALORES NO TRABALHO",abbr:"VLT",factors:[12],color:"#10b981",desc:"Justiça organizacional, respeito e equidade."},
    ],
    defaultFontes: Array(15).fill("").map((_,i)=>["Sobrecarga de tarefas e prazos apertados.","Ritmo de trabalho acelerado e sem pausas.","Alta demanda de concentração e memória.","Exigências emocionais excessivas no contato com usuários.","Baixa autonomia e influência sobre as decisões.","Poucas oportunidades de aprendizado e crescimento.","Falta de informação antecipada sobre mudanças.","Esforço não reconhecido pela organização.","Ambiguidade ou conflito nas responsabilidades.","Liderança ineficaz ou distante.","Falta de suporte entre colegas de equipe.","Baixa confiança na gestão e nas decisões organizacionais.","Percepção de injustiça nas decisões e tratamento.","Dificuldade em conciliar demandas do trabalho e da família.","Saúde geral prejudicada pelas condições de trabalho."][i]),
    formulaNote: 'Score COPSOQ = média das respostas × 25 · Escala 1–5 → 0–100 · Valores altos em Exigências = maior risco; valores altos em Recursos = fator protetor.'
  },
  ...
  copsoq2m: {
    ...
    scoring: 'copsoq',
    factors: [
      {name:"Exigências Quantitativas",qs:[0,1,2,3]},
      {name:"Ritmo de Trabalho",qs:[4]},
      {name:"Exigências Cognitivas",qs:[5,6,7,8]},
      {name:"Exigências Emocionais",qs:[9,10,11,12]},
      {name:"Exigências para Esconder Emoções",qs:[13,14]},
      {name:"Influência no Trabalho",qs:[15,16,17,18]},
      {name:"Possibilidades de Desenvolvimento",qs:[19,20,21,22]},
      {name:"Significado do Trabalho",qs:[23,24,25]},
      {name:"Comprometimento com o Local de Trabalho",qs:[26,27,28]},
      {name:"Previsibilidade",qs:[29,30]},
      {name:"Reconhecimento e Recompensas",qs:[31,32,33]},
      {name:"Transparência do Papel",qs:[34,35,36]},
      {name:"Conflitos de Papel",qs:[37,38,39]},
      {name:"Qualidade da Liderança",qs:[40,41,42,43]},
      {name:"Apoio Social de Superiores",qs:[44,45,46]},
      {name:"Apoio Social de Colegas",qs:[47,48,49]},
      {name:"Comunidade Social no Trabalho",qs:[50,51,52]},
      {name:"Confiança na Liderança",qs:[53,54,55,56]},
      {name:"Confiança nos Colegas",qs:[57,58]},
      {name:"Justiça e Respeito",qs:[59,60,61,62]},
      {name:"Insegurança no Trabalho",qs:[63,64]},
      {name:"Satisfação no Trabalho",qs:[65,66,67]},
      {name:"Conflito Trabalho-Família",qs:[68,69,70]},
      {name:"Burnout",qs:[71]},
    ],
    dimensions: [
      {name:"EXIGÊNCIAS NO TRABALHO",abbr:"EXT",factors:[0,1,2,3,4],color:"#ef4444",desc:"Demandas quantitativas, cognitivas, emocionais e ritmo."},
      {name:"ORGANIZAÇÃO E CONTEÚDO",abbr:"ORC",factors:[5,6,7,8,9,10],color:"#f59e0b",desc:"Influência, desenvolvimento, significado, comprometimento, previsibilidade, reconhecimento."},
      {name:"RELAÇÕES E LIDERANÇA",abbr:"REL",factors:[11,12,13,14,15,16,17,18],color:"#3b82f6",desc:"Papel, conflitos, liderança, apoio e confiança."},
      {name:"INTERFACE TRABALHO-FAMÍLIA",abbr:"ITF",factors:[22],color:"#8b5cf6",desc:"Conflito entre trabalho e vida privada."},
      {name:"VALORES E BEM-ESTAR",abbr:"VBE",factors:[19,20,21,23],color:"#10b981",desc:"Justiça, insegurança, satisfação e burnout."},
    ],
    defaultFontes: Array(24).fill("Fator identificado na avaliação — editar fonte geradora."),
    formulaNote: 'Score COPSOQ = média × 25 · Escala 1–5 → 0–100 · Versão extendida com 24 dimensões.'
  },
